...
@Component({
  selector: 'tr[app-spesa1]',
  templateUrl: './spesa1.component.html',
  styleUrls: ['./spesa1.component.css']
})
export class Spesa1Component implements OnInit {

  // variabili passate dal componente padre
  @Input('spesa1-data') spesa: Spesa;
  @Input('spesa1-prog') i: number;
  ...
  */
  ...
  showSpesaDetail(functionUser: string) {
   // alert('da fare -  functionUser passata dal Padre : ' + functionUser);
    ...
    switch (functionUser) {
// salvo su localstorage la path per il ritorno
         case 'Inqu':
