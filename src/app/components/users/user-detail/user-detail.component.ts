...
<<<<<<< HEAD
  vecchio modulo di lettura dati per dettaglio

checkFunctionbylevelActual() {
   ...
   this.ctrfuncService.getfuncbyProfilo(this.level, this.rotta).subscribe(
     res =>{
      ...
      if(this.functionUrlUp !== this.functionUserUp) {
       if(this.functionUrl !== 'edit' && this.functionUrl !== 'edits' && this.functionUrl !== 'new') {
