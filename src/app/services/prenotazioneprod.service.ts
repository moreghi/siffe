...
import { Prenotazioneprod } from '../classes/Prenotazioneprod';
...
export class PrenotazioneprodService {

  public prenotazioneprod: Prenotazioneprod;


  private rotta = "/prenotazioneprod";
  ...
  getAuthHeader(): HttpHeaders   {
    ...
    // la chiamata la faccio solo se ho il token per abilitare la lettura solo a uteti loggati
        ...
        delete(prenotazioneprod: Prenotazioneprod) {

          this.rottafunction = 'deletebyid';
          return this.http.delete(this.APIURL + '/' + this.rottafunction + '/' + prenotazioneprod.id,  {
            headers: this.getAuthHeader()
          });      // ok

        }

    update(prenotazioneprod: Prenotazioneprod) {

      this.rottafunction = 'updatebyid';
      return this.http.put(this.APIURL + '/' + this.rottafunction + '/' +  prenotazioneprod.id, prenotazioneprod,  {
        headers: this.getAuthHeader()
      });      // ok
    }


     create(prenotazioneprod: Prenotazioneprod){
      this.rottafunction = 'create';
      return this.http.post(this.APIURL + '/' + this.rottafunction, prenotazioneprod,  {
         headers: this.getAuthHeader()
      });      // ok
    }
